...
────────────────────────────────────────────────────────
nimbus-landing        →   abfss://bronze@<storage>.dfs.core.windows.net
nimbus-processed      →   abfss://silver@<storage>.dfs.core.windows.net
nimbus-gold           →   abfss://gold@<storage>.dfs.core.windows.net
nimbus-quarantine     →   abfss://quarantine@<storage>.dfs.core.windows.net
```
...
storage_account = dbutils.secrets.get("kv-nimbus", "storage-account-name")
```
...
──────────────────────────────────────────────────────────────────────────────
bronze       data/landing/         nimbus-bronze      abfss://bronze@...
silver       data/processed/       nimbus-silver      abfss://silver@...
gold         data/gold/            nimbus-gold        abfss://gold@...
quarantine   data/quarantine/      nimbus-quarantine  abfss://quarantine@...
contracts    data/contracts/       nimbus-contracts   abfss://contracts@...
metrics      data/metrics/         nimbus-metrics     abfss://metrics@...
reports      data/reports/         nimbus-reports     abfss://reports@...
```
